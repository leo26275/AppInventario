...
public class ReporteCostoProductoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_costo_producto);
    ...
    public void showData(){
        String url ="http://192.168.0.6:80/AppInventory/ReporteCosto.php";
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ReporteCostoProductoActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }){
            @Override
