...
public class AdapterReporteCostoProducto extends ArrayAdapter<ReportePro> {
    Context context;
    List<ReportePro> arrayPro;
    Bitmap bitmap;

    public AdapterReporteCostoProducto(Context context, List<ReportePro> arrayPro) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_custom_reporte_costo_producto, null, true);
